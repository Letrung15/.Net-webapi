...
namespace VuongLeTrung.Exercise02.Controllers
{
    ...
    public class AttributeController : ControllerBase
    {
        ...
        [HttpGet]
        public IEnumerable<VuongLeTrung.Exercise02.Models.Attribute> Get()
        {
            return _db.Attributes.ToList();
        }

        [HttpGet("{id}")]
        public ActionResult<VuongLeTrung.Exercise02.Models.Attribute> Get(Guid id)
        {
        ...
        [HttpPost]
        public ActionResult<VuongLeTrung.Exercise02.Models.Attribute> Post([FromBody] VuongLeTrung.Exercise02.Models.Attribute attribute)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(Guid id, [FromBody] VuongLeTrung.Exercise02.Models.Attribute attribute)
        {
            if (id != attribute.Id)
            {
                return BadRequest();
